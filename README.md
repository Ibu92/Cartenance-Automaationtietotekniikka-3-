...
Cartenance is a car maintenance tracking app for vehicle owners. It includes a React PWA frontend, an Express API, SQLite persistence, photo uploads, and PDF exports.
